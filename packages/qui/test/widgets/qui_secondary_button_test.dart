  ...
  group('QuiSecondaryButton', () {
    ...
    testWidgets('when enabled, it should wrap in QuiTapAnimation with scaleFade animation', (tester) async {
      ...
      final animation = tester.widget<QuiTapAnimation>(
        find.descendant(of: find.byType(QuiSecondaryButton), matching: find.byType(QuiTapAnimation)),
      );
    ...
    testWidgets('when fit is expand, it should fill the available width', (tester) async {
      ...
      expect(tester.getSize(find.byKey(const Key('qui_secondary_button_container'))).width, equals(300));
    });
    ...
    testWidgets('when fit is fit, it should size to content', (tester) async {
      ...
      final buttonWidth = tester.getSize(find.byKey(const Key('qui_secondary_button_container'))).width;
